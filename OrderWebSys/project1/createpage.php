...
/*-------------------------處理用戶姓名-------------------------------------*/
   ...
   $(document).on('change','select#address_1',function() {
  
    /*  var taipei='<div style="width:150px;padding-bottom:2px;padding-top:5px;" class="ui-block-b">'+ 
                '<label for="address3333"></label>'+
...
*/
    ...
    //$('div.ui-block-a').after(taipei);
   // $('select').selectmenu("refresh", true);
  });


      $(document).on('focus','select#address_1',function(){
      ...
      $(document).on('change','select#address_2',function(){
      ...
      $(document).on('focus','select#address_2',function(){
      ...
      $(document).on('blur','input[name=address_3]',function(){
      ...
      $(document).on('focus','input[name=address_3]',function(){
